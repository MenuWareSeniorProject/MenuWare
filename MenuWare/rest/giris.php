...
<head>
  ...
  <title><?=$ayarData['ayar_title']; ?> | Restaurant Paneli</title>
            ...
            <div class="col-lg-12">
              <div class="login-form">
                <div class="text-center">
                  <h1 class="h4 text-gray-900 mb-4">Restaurant Girişi</h1>
                </div>
                <form action="inc/islemler.php" method="POST">
                  <div class="form-group">
                    <input type="text" name="yetkili_adi" class="form-control" placeholder="Kullanıcı Adınız" required>
                  </div>
                  <div class="form-group">
                    <input type="password" name="yetkili_parola"  class="form-control" placeholder="Parolanız" required>
                  </div>
