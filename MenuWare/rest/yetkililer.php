      ...
      <div class="card mb-4">
        ...
        <div class="table-responsive p-3">
          ...
          <table class="table align-items-center table-flush" id="dataTableHover">
            ...
            <tbody>
              <?php 
              $veriCek=$conn->prepare("SELECT * FROM yetkili,restoran WHERE restoran.rest_id=yetkili.yetkili_rest_id and yetkili.yetkili_rest_id = '{$restoran_id}' ORDER BY yetkili.yetkili_adi ASC ");
              $veriCek->execute();
